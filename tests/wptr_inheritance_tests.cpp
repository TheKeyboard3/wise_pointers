...
int main(int argc, char **argv) {
    ...
    const int len = 7;
    test_exec tests[len] = {
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_assignment,"wptr_inheritance_test_assignment"),
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_comparison,"wptr_inheritance_test_comparison"),
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_constructor,"wptr_inheritance_test_constructor"),
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_constructor_copy,"wptr_inheritance_test_constructor_copy"),
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_duplicate,"wptr_inheritance_test_duplicate"),
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_member_access,"wptr_inheritance_test_member_access"),
        test_exec(&wptr_inheritance_tests::wptr_inheritance_test_reference,"wptr_inheritance_test_reference"),
    };
    for(int i = 0; i < len; i++){
